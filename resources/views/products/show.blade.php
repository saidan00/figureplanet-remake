        ...
        <div class="flex-r-m flex-w p-t-10">
          <div class="w-size16 flex-m flex-w">
            <div class="flex-w bo5 of-hidden m-r-22 m-t-10 m-b-10">
              ...
              <input class="size8 m-text18 t-center num-product" type="number" name="num-product" id="num-product"
                value="1">
            ...
            <div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10" data-product-id="{{ $product->id }}">
              <!-- Button -->
